...
## 2 *SKIP THIS IF USING LAB COMPUTER, ADMIN RIGHTS REQUIRED*. Install [SQL Server Express](https://www.microsoft.com/en-us/sql-server/sql-server-editions-express)
